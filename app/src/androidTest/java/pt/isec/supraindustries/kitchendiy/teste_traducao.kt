...
class teste_traducao {
    ...
    fun teste_traducao() {
        val button = onView(
            allOf(
                withId(R.id.btnEscolherIngredientes), withText("CHOOSING THE INGREDIENTS"),
        ...
        val button3 = onView(
            allOf(
                withId(R.id.btnInformacoes), withText("INFORMATION"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button4 = onView(
            allOf(
                withId(R.id.btn_recomendar_receita), withText("RECOMMEND RECIPE"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button5 = onView(
            allOf(
                withId(R.id.btn_recomendar_ingrediente), withText("RECOMMEND INGREDIENT"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val textView = onView(
            allOf(
                withId(android.R.id.text1), withText("Select Language"),
                withParent(
                    allOf(
                        withId(R.id.spinner),
        ...
        val textView2 = onView(
            allOf(
                withId(R.id.row_receita_nome), withText("Chourizo Bread"),
        ...
        val materialButton2 = onView(
            allOf(
                withId(R.id.btnInicio), withText("Home"),
                childAtPosition(
                    childAtPosition(
        ...
        val checkedTextView = onView(
            allOf(
                withId(android.R.id.text1), withText("Português"),
        ...
        val checkedTextView2 = onView(
            allOf(
                withId(android.R.id.text1), withText("English"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.FrameLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button6 = onView(
            allOf(
                withId(R.id.btnEscolherIngredientes), withText("ESCOLHER OS INGREDIENTES"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button8 = onView(
            allOf(
                withId(R.id.btnInformacoes), withText("INFORMAÇÕES"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button9 = onView(
            allOf(
                withId(R.id.btn_recomendar_receita), withText("RECOMENDAR RECEITA"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val button10 = onView(
            allOf(
                withId(R.id.btn_recomendar_ingrediente), withText("RECOMENDAR INGREDIENTE"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        ...
        val textView3 = onView(
            allOf(
                withId(R.id.row_receita_nome), withText("Pão com Chouriço"),
                withParent(withParent(withId(R.id.receitas_rv))),
                isDisplayed()
            )
        )
        ...
        val editText4 = onView(
            allOf(
                withId(R.id.receita_nome), withText("Pão com Chouriço"),
                withParent(withParent(withId(android.R.id.content))),
                isDisplayed()
            )
        )
